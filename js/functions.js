...
background.initializr = function () {
  ...
  $this.style = {bubbles_color:"blue",stroke_width:0, stroke_color :"black"};
  ...
  $this.object = $("<div style='z-inde:-1;margin:0;padding:0; overflow:hidden;position:absolute;bottom:0' id='"+$this.id+"'> </div>'").appendTo("#about");
